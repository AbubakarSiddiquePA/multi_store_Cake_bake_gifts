...
class SaveTheDate extends StatelessWidget {
      ...
      child: Stack(
        children: [
          Positioned(
            ...
            child: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  const CategoryHeaderLabel(headerLabel: "SAVE THE DATE"),
                  SizedBox(
          ...
          const Positioned(
            bottom: 0,
            right: 0,
            child: SliderBar(maincategName: "Save the date"),
          )
        ],
      ),
    );
